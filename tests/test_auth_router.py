...
class VerifyOtpTests(unittest.TestCase):
    ...
    def test_verify_otp_succeeds_when_verify_rate_limit_table_is_missing(self):
        client = _build_client()
    ...
    def test_invalid_verify_otp_returns_invalid_when_verify_rate_limit_table_is_missing(self):
        client = _build_client()
